// @observablehq/runtime v4.7.1 Copyright 2020 Observable, Inc.
function e(e, t, n) {
    n = n || {};
...
// function w(n, i, o, a) {
//     let s, l, u, c, d = t(n);
//     n instanceof Map ? (s = `Map(${n.size})`, l = g) : n instanceof Set ? (s = `Set(${n.size})`, l = y) : d ? (s = `${n.constructor.name}(${n.length})`, l = x) : (c = m(n)) ? (s = `Immutable.${c.name}${"Record"===c.name?"":`(${n.size})`}`, d = c.arrayish, l = c.arrayish ? C : c.setish ? E : P) : a ? (s = f(n), l = N) : (s = f(n), l = S);
...
// function k(e, n, i, o) {
//     let a, s, l, u, c = t(e);
//     if (e instanceof Map ? (a = `Map(${e.size})`, s = A) : e instanceof Set ? (a = `Set(${e.size})`, s = O) : c ? (a = `${e.constructor.name}(${e.length})`, s = R) : (u = m(e)) ? (a = `Immutable.${u.name}${"Record"===u.name?"":`(${e.size})`}`, c = u.arrayish, s = u.arrayish ? U : u.setish ? T : F) : (a = f(e), s = D), n) {
//         const t = document.createElement("span");
...
//             j(t) || (n.stopPropagation(), ae(t, k(e)))
//         })), t
//     }
...
//         j(d) || (t.stopPropagation(), ae(d, w(e, 0, i, o)))
//     }), !0), s = s(e);
    ...
    switch (s) {
        ...
        case "function":
            return function(e, t) {
                ...
                return n === ee ? re(n, "", t) : (r = /^(?:async\s*)?(\w+)\s*=>/.exec(i)) ? re(n, "(" + r[1] + ")", t) : (r = /^(?:async\s*)?\(\s*(\w+(?:\s*,\s*\w+)*)?\s*\)/.exec(i)) ? re(n, r[1] ? "(" + r[1].replace(/\s*,\s*/g, ", ") + ")" : "()", t) : (r = /^(?:async\s*)?function(?:\s*\*)?(?:\s*\w+)?\s*\(\s*(\w+(?:\s*,\s*\w+)*)?\s*\)/.exec(i)) ? re(n, r[1] ? "(" + r[1].replace(/\s*,\s*/g, ", ") + ")" : "()", t) : re(n, "(…)", t)
            }(e, i);
        case "string":
...
class FileAttachment {
    ...
    async blob() {
        return (await ue(this)).blob()
    }
    async arrayBuffer() {
        return (await ue(this)).arrayBuffer()
    }
    async text() {
        return (await ue(this)).text()
    }
    async json() {
        return (await ue(this)).json()
    }
    async stream() {
        return (await ue(this)).body
    }
    async image() {
...
const de = new Map,
    ...
    ve = "https://cdn.jsdelivr.net/npm/",
    be = /^((?:@[^/@]+\/)?[^/@]+)(?:@([^/]+))?(?:\/(.*))?$/,
    _e = /^\d+\.\d+\.\d+(-[\w-.+]+)?$/,
    we = /\.[^/]*$/,
    ge = ["unpkg", "jsdelivr", "browser", "main"];
...
function Ee(e) {
    const t = `${ve}${e.name}${e.version?`@${e.version}`:""}/package.json`;
    let n = de.get(t);
...
var xe = Ce((async function(e, t) {
    if (e.startsWith(ve) && (e = e.substring(ve.length)), /^(\w+:)|\/\//i.test(e)) return e;
    ...
    const n = ye(e);
    if (!n) return `${ve}${e}`;
    if (!n.version && null != t && t.startsWith(ve)) {
        const e = await Ee(ye(t.substring(ve.length)));
        n.version = e.dependencies && e.dependencies[n.name] || e.peerDependencies && e.peerDependencies[n.name]
    }
    if (n.path && !we.test(n.path) && (n.path += ".js"), n.path && n.version && _e.test(n.version)) return `${ve}${n.name}@${n.version}/${n.path}`;
    const r = await Ee(n);
    return `${ve}${r.name}@${r.version}/${n.path||function(e){for(const t of ge){const n=e[t];if("string"==typeof n)return we.test(n)?n:`${n}.js`}}(r)||"index.js"}`
}));
...
function Ce(e) {
    ...
    function o(e) {
        return arguments.length > 1 ? Promise.all(pe.call(arguments, n)).then(Ne) : n(e)
    }
...
function qe(e, t, n) {
    ...
    r < 2 ? (n = e, t = []) : r < 3 && (n = t, t = "string" == typeof e ? [] : e), fe.push(he.call(t, Pe) ? e => {
        const r = {},
            i = {
                exports: r
            };
...
var ke = {
    ...
    element: function(e, t) {
        ...
        var o = $e.hasOwnProperty(r) ? document.createElementNS($e[r], e) : document.createElement(e);
        if (t)
            for (var a in t) i = (r = a).indexOf(":"), n = t[a], i >= 0 && "xmlns" !== (r = a.slice(0, i)) && (a = a.slice(i + 1)), $e.hasOwnProperty(r) ? o.setAttributeNS($e[r], a, n) : o.setAttribute(a, n);
        return o
    },
    input: function(e) {
    ...
    return function() {
        return e("marked@0.3.12/marked.min.js").then((function(t) {
            return Fe((function(n) {
                ...
                return i.length > 0 && e(ze + "highlight.min.js").then((function(t) {
                    i.forEach((function(n) {
                        function r() {
                            t.highlightBlock(n), n.parentNode.classList.add("observablehq--md-pre")
                        }
                        t.getLanguage(n.className) ? r() : e(ze + "async-languages/index.js").then(r => {
                            if (r.has(n.className)) return e(ze + "async-languages/" + r.get(n.className)).then(e => {
...
function Ge(e, t) {
    var n;
    return (n = Ve.get(e = +e)) ? n.then(Me(t)) : (n = Date.now()) >= e ? Promise.resolve(t) : function(e, t) {
...
function et(e) {
    return function() {
        return Promise.all([e("@observablehq/katex@0.11.1/dist/katex.min.js"), e.resolve("@observablehq/katex@0.11.1/dist/katex.min.css").then(Ze)]).then((function(e) {
            var t = e[0],
                n = r();
...
function dt(e, t, n) {
    var r;
    null == n && (n = ct), Object.defineProperties(this, {
        _observer: {
            value: n,
            writable: !0
        },
        ...
        _rejector: {
            value: (r = this, function(e) {
                if (e === ht) throw new rt(r._name + " is not defined", r._name);
...
function vt(e, t, n) {
    ...
    if (this._inputs.forEach(pt, this), t.forEach(ft, this), this._inputs = t, this._definition = n, this._value = void 0, n === ut ? i._variables.delete(this) : i._variables.add(this), e == this._name && r.get(e) === this) this._outputs.forEach(i._updates.add, i._updates);
    else {
        var o, a;
        if (this._name)
        ...
        e && ((a = r.get(e)) ? 3 === a._type ? (this._definition = mt(e), this._duplicate = n, a._duplicates.add(this)) : 2 === a._type ? (this._outputs = a._outputs, a._outputs = new Set, this._outputs.forEach((function(e) {
            e._inputs[e._inputs.indexOf(a)] = this
        }), this), i._dirty.add(a).add(this), r.set(e, this)) : (a._duplicate = a._definition, this._duplicate = n, (o = new dt(3, this._module))._name = e, o._definition = this._definition = a._definition = mt(e), o._outputs = a._outputs, a._outputs = new Set, o._outputs.forEach((function(e) {
...
Object.defineProperties(dt.prototype, {
    ...
    define: {
        value: function(e, t, n) {
            ...
            return vt.call(this, null == e ? null : e + "", null == t ? [] : ot.call(t, this._module._resolve, this._module), "function" == typeof n ? n : st(n))
        },
        writable: !0,
        configurable: !0
    },
    ...
    import: {
        value: function(e, t, n) {
            ...
            return vt.call(this, t + "", [n._resolve(e + "")], lt)
        },
        writable: !0,
        configurable: !0
    }
            ...
            for (const [o, a] of this._scope) {
                ...
                if (!n || 1 !== n._type)
                    if (a._definition === lt) {
                        var r = a._inputs[0],
                            i = r._module;
                        e.import(r._name, o, t.get(i) || (i._source ? i._copy(new bt(e._runtime, e._builtins), t) : i))
                    } else e.define(o, a._inputs.map(_t), a._definition)
            }
            return e
        },
        writable: !0,
    ...
    _resolve: {
        value: function(e) {
            ...
            if (!n)
                if (n = new dt(2, this), this._builtins.has(e)) n.define(e, st(this._builtins.get(e)));
                ...
                void 0 === t ? this._scope.set(n._name = e, n) : n.define(e, st(t))
            }
            var r;
            return n
        },
    ...
    derive: {
        value: function(e, t) {
            var n = new bt(this._runtime, this._builtins);
            return n._source = this, at.call(e, (function(e) {
                "object" != typeof e && (e = {
                    name: e + ""
    ...
    value: {
        value: async function(e) {
            var t = this._scope.get(e);
            if (!t) throw new rt(e + " is not defined");
            t._observer === ct && (t._observer = !0, this._runtime._dirty.add(t));
...
const wt = "function" == typeof requestAnimationFrame ? requestAnimationFrame : setImmediate;
var gt = {},
    yt = {};

function Et(e = new nt, t = jt) {
    var n = this.module();
    if (Object.defineProperties(this, {
        ...
        for (var r in e) new dt(2, n).define(r, [], e[r])
}
...
function Mt(e) {
    ...
    var t = e._value,
        ...
        i = e._promise = Promise.all(e._inputs.map(St)).then((function(i) {
            ...
            }(t) ? e._version !== n ? void t.return() : ((r || Pt(e)).then((o = t, function() {
                o.return()
            })), function(e, t, n, r) {
                function i() {
                    var n = new Promise((function(e) {
                        ...
                        return r.done ? void 0 : Promise.resolve(r.value).then((function(r) {
                            if (e._version === t) return $t(e, r, n).then(i), e._fulfilled(r), r
                        }))
                    }));
                    n.catch((function(r) {
...
function Lt(e, t) {
    e._invalidate(), e._invalidate = ut, e._pending(), ++e._version, e._indegree = NaN, (e._promise = Promise.reject(t)).catch(ut), e._value = void 0, e._rejected(t)
}
...
Object.defineProperties(Et, {
    ...
    _computeNow: {
        value: function() {
            ...
            (e = new Set(this._dirty)).forEach((function(t) {
                ...
                e._outputs.forEach(Ct)
            }));
            do {
                for (e.forEach((function(e) {
                        0 === e._indegree && n.push(e)
                    })); t = n.pop();) Mt(t), t._outputs.forEach(r), e.delete(t);
                e.forEach((function(t) {
                    xt(t) && (Lt(t, new rt("circular definition")), t._outputs.forEach(Nt), e.delete(t))
                }))
            } while (e.size);
    ...
    module: {
        value: function(e, t = ut) {
            let n;
            if (void 0 === e) return (n = this._init) ? (this._init = null, n) : new bt(this);
            if (n = this._modules.get(e), n) return n;
            this._init = n = new bt(this), this._modules.set(e, n);
            try {
                e(this, t)
            } finally {
                this._init = null
...
export {
    le as Inspector, nt as Library, Et as Runtime, rt as RuntimeError
};